...
public class InputFrm extends javax.swing.JInternalFrame {
	...
	private void initComponents() {
		...
		/*权限判断，后勤不显示返利、净利润标签和输入框*/
		if(loginUser!=null && "后勤".equals(loginUser.getLevel())){
		...
		caridLabel.setFont(new java.awt.Font("微软雅黑", 0, 16));
		...
		startdateLabel.setFont(new java.awt.Font("微软雅黑", 0, 16));
		...
		teamtypeLabel.setFont(new java.awt.Font("微软雅黑", 0, 16));
		teamtypeLabel.setText("\u56e2\u961f\u6027\u8d28");

		tripLabel.setFont(new java.awt.Font("微软雅黑", 0, 16));
		tripLabel.setText("\u884c\u7a0b");

		carincomeLabel.setFont(new java.awt.Font("微软雅黑", 0, 16));
		carincomeLabel.setText("\u8f66\u8d39");

		netpayLabel.setFont(new java.awt.Font("微软雅黑", 0, 16));
		netpayLabel.setText("\u7f51\u4ed8");

		idealincomeLabel.setFont(new java.awt.Font("微软雅黑", 0, 16));
		idealincomeLabel.setText("\u73b0\u6536");

		realincomeLabel.setFont(new java.awt.Font("微软雅黑", 0, 16));
		realincomeLabel.setText("\u5b9e\u9645\u73b0\u6536");

		idealguaranteeLabel.setFont(new java.awt.Font("微软雅黑", 0, 16));
		idealguaranteeLabel.setText("\u4fdd\u5e95");

		realguaranteeLabel.setFont(new java.awt.Font("微软雅黑", 0, 16));
		realguaranteeLabel.setText("\u5b9e\u6536\u4fdd\u5e95");

		petrolcostLabel.setFont(new java.awt.Font("微软雅黑", 0, 16));
		petrolcostLabel.setText("\u516c\u53f8\u52a0\u6cb9");

		drivingcostLabel.setFont(new java.awt.Font("微软雅黑", 0, 16));
		drivingcostLabel.setText("\u884c\u8f66\u8d39\u7528");

		otherLabel.setFont(new java.awt.Font("微软雅黑", 0, 16));
		otherLabel.setText("\u5176\u4ed6");

		rebateLabel.setFont(new java.awt.Font("微软雅黑", 0, 16));
		rebateLabel.setText("\u8fd4\u5229");

		rebateTextField.setFont(new java.awt.Font("微软雅黑", 0, 16));

		netprofitLabel.setFont(new java.awt.Font("微软雅黑", 0, 16));
		netprofitLabel.setText("\u51c0\u5229\u6da6");

		submitButton.setFont(new java.awt.Font("微软雅黑", 1, 16));
		...
		resetButton.setFont(new java.awt.Font("微软雅黑", 1, 16));
