 ...
 * @author  __USER__
 */
public class EditFrm extends javax.swing.JInternalFrame {
	...
	public EditFrm(User loginUser,FleetTableBean oldFleetTableBean,String actionFlag){
		this.loginUser = loginUser;
	...
	private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {
		/*µ÷ÓÃservice²ã*/
		FleetTableSV fleetTableSV = new FleetTableSV();
		/*µÃµ½ÓÃ»§´«ÈëµÄÊý¾Ý£¬Îª¿ÕÔò½«Æä¸³ÖµÎª¡°-1¡±*/
		...
		fleetTableBean.setId(oldFleetTableBean.getId());
		...
		try{
			fleetTableSV.update(fleetTableBean);
		}catch(Exception e){
			JOptionPane.showMessageDialog(null, "¸üÐÂÊ§°Ü", "¸üÐÂÊ§°Ü", 0);
		}
		JOptionPane.showMessageDialog(null, "¸üÐÂ³É¹¦", "¸üÐÂ³É¹¦", 0);	
	}
